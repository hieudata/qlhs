    ...
    <div class="row justify-content-center">
      <div class="col-xl-11 col-lg-12 col-md-9">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="login-form">
                  <h5 align="center">Hệ thống điểm danh</h5>
                  ...
                  <form class="user" method="Post" action="">
                    ...
                    <div class="form-group">
                      <input type="password" name="password" required class="form-control" id="exampleInputPassword" placeholder="Nhập pass">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <input type="submit" class="btn btn-dark btn-block" value="Đăng nhập" name="login" />
                    </div>
                  </form>
        ...
        Invalid Username/Password!
                      ...
                      $query = "SELECT * FROM giaovien WHERE email = '$username' AND password = '$password'";
                      $rs = $conn->query($query);
                      $num = $rs->num_rows;
                      $rows = $rs->fetch_assoc();
                      ...
                      if ($num > 0) {
                        ...
                        $_SESSION['lastName'] = $rows['lastName'];
                        $_SESSION['email'] = $rows['email'];
                        $_SESSION['maKhoi'] = $rows['maKhoi'];
                        $_SESSION['maLop'] = $rows['maLop'];
